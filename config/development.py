...
# MySQL database connection via Docker
SQLALCHEMY_DATABASE_URI = os.getenv(
    "SQLALCHEMY_DATABASE_URI",
    "mysql+pymysql://license_user:license_password@localhost:3306/license_tracker"
)

SQLALCHEMY_BINDS = {}

SECRET_KEY = os.getenv("SECRET_KEY", default="change-me-dev")
import datetime
...
DB_NAME = os.getenv("DB_NAME", default="license_tracker")
DB_TYPE = os.getenv("DB_TYPE", default="mysql")
USERNAME = os.getenv("USERNAME", default="license_user")
PASSWORD = os.getenv("PASSWORD", default="license_password")
