-- Generate expanded license history data (100x expansion)
-- This script uses stored procedures to generate 2000 history records
...
-- Generate 2000 license history records
CALL generate_license_history(2000);

-- Optional: Drop procedure after use
-- DROP PROCEDURE IF EXISTS generate_license_history;

SELECT CONCAT('Generated ', COUNT(*), ' license history records') AS result FROM license_history_logs;
